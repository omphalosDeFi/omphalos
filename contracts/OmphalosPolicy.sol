...
/**
 * @title omphalos Monetary Supply Policy
 * @dev This is an implementation of the omphalos Ideal Money protocol.
 *      omphalos operates symmetrically on expansion and contraction. It will both split and
 *      combine coins to maintain a stable unit price.
 *
 *      This component regulates the token supply of the omphalos ERC20 token in response to
 *      market oracles.
 */
contract OmphalosPolicy is Ownable {
     ...
     */
    function initialize(address owner_, Omphalos uFrags_, uint256 baseCpi_)
        public
        initializer
    {
